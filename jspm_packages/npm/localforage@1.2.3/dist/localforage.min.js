  ...
  !function() {
    ...
    function c(a) {
      ...
      var k = new ArrayBuffer(h),
          l = new Uint8Array(k);
      for (b = 0; i > b; b += 4)
        c = e.indexOf(a[b]), d = e.indexOf(a[b + 1]), f = e.indexOf(a[b + 2]), g = e.indexOf(a[b + 3]), l[j++] = c << 2 | d >> 4, l[j++] = (15 & d) << 4 | f >> 2, l[j++] = (3 & f) << 6 | 63 & g;
      return k;
    }
    function d(a) {
      var b,
      ...
      for (b = 0; b < c.length; b += 3)
        d += e[c[b] >> 2], d += e[(3 & c[b]) << 4 | c[b + 1] >> 4], d += e[(15 & c[b + 1]) << 2 | c[b + 2] >> 6], d += e[63 & c[b + 2]];
    ...
    "undefined" != typeof module && module.exports && "undefined" != typeof require ? module.exports = t : "function" == typeof define && define.amd ? define("localforageSerializer", function() {
      return t;
    ...
    if (l) {
      ...
      "undefined" != typeof module && module.exports && "undefined" != typeof require ? module.exports = m : "function" == typeof define && define.amd ? define("asyncStorage", function() {
        return m;
      }) : this.asyncStorage = m;
    }
  }.call(window), function() {
